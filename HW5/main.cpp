...
int main(){
  ...
  //sketch_arr[1] --> CountMinMeanSketch(0.01, 0.003);
  //sketch_arr[2] --> CountSketch(0.01, 0.003);

  //sketch_arr[3] --> CountMinSketch(0.001, 0.003);
  //sketch_arr[4] --> CountMinMeanSketch(0.001, 0.003);
  //sketch_arr[5] --> CountSketch(0.001, 0.003);

  //sketch_arr[6] --> CountMinSketch(0.001, 0.00001);
  //sketch_arr[7] --> CountMinMeanSketch(0.001, 0.00001);
  //sketch_arr[8] --> CountSketch(0.001, 0.00001);
